...
class TypeMapperTest {
    ...
    @Test void geometry_mapsToGeometryWithWarning() { TypeMapper.MappedType r = mapper.mapType(col("geometry")); assertEquals("GEOMETRY", r.tidbType()); assertTrue(r.hasWarning()); }
