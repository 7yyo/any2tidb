...
class SqlServerExtractorTest {
    ...
    @Test
    void listDatabases_returnsDatabaseNames() throws SQLException {
    ...
    @Test
    void listDatabases_empty_returnsEmptyList() throws SQLException {
        Statement st = mock(Statement.class);
        ResultSet rs = mock(ResultSet.class);
        when(conn.createStatement()).thenReturn(st);
        when(st.executeQuery(anyString())).thenReturn(rs);
    ...
    @Test
    void listTables_noFilter_returnsAll() throws SQLException {
    ...
    @Test
    void listTables_withSchemaFilter_setsParameter() throws SQLException {
        PreparedStatement ps = mock(PreparedStatement.class);
        ResultSet rs = mock(ResultSet.class);
        when(conn.prepareStatement(anyString())).thenReturn(ps);
        when(ps.executeQuery()).thenReturn(rs);
     ...
     */
    @Test
    void extractTable_basicColumns_parsedCorrectly() throws SQLException {
    ...
    @Test
    void extractTable_computedColumn_flaggedCorrectly() throws SQLException {
        ResultSet colRs = mock(ResultSet.class);
        when(colRs.next()).thenReturn(true, false);
    ...
    @Test
    void extractTable_withForeignKeys_countsCorrectly() throws SQLException {
        ResultSet emptyRs = mock(ResultSet.class);
        when(emptyRs.next()).thenReturn(false);
    ...
    @Test
    void extractTable_partitioned_flaggedCorrectly() throws SQLException {
        ResultSet emptyRs = mock(ResultSet.class);
        when(emptyRs.next()).thenReturn(false);
    ...
    @Test
    void extractTable_withIndex_parsedCorrectly() throws SQLException {
        ResultSet emptyRs = mock(ResultSet.class);
        when(emptyRs.next()).thenReturn(false);
    ...
    @Test
    void extractTable_columnWithDefaultAndComment_parsed() throws SQLException {
        ResultSet colRs = mock(ResultSet.class);
        when(colRs.next()).thenReturn(true, false);
    ...
    @Test
    void listTables_withTableFilter_setsParameter() throws SQLException {
        PreparedStatement ps = mock(PreparedStatement.class);
        ResultSet rs = mock(ResultSet.class);
        when(conn.prepareStatement(anyString())).thenReturn(ps);
        when(ps.executeQuery()).thenReturn(rs);
